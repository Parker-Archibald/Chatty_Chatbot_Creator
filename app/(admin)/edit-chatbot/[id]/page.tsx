...
function EditChatBot({ params: { id } }: { params: { id: string } }) {
  ...
  return (
    <div className="px-0 md:p-10">
      <div className="md:sticky md:top-0 z-50 sm:max-w-sm ml-auto space-y-2 md:border p-5 rounded-b-lg md:rounded-lg bg-[#F07896]">
      ...
      <section className="relative mt-5 bg-white p-5 md:p-10 rounded-lg">
        ...
        <div className="flex space-x-4">
          ...
          >
            ...
            />
            <Button type="submit" disabled={!chatbotName} className=" cursor-pointer">
              Update
            </Button>
          </form>
        </div>
